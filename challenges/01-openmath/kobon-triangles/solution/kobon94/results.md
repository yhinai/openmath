...
- N=23: first UNSAT K=—, first SAT K=0; TIMEOUT at K=[2]
...
Genuine N=18 models (`s SATISFIABLE`) on record: K=9, 12, 15, 17, 19, 20, 22
...
K=2, 3, 4, 5, 6, 7, 8, 10, 11, 13, 14, 16, 18, 21 TIMEOUT; K=9, 12, 15, 17, 19, 20, 22 SAT.
