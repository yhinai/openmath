...
- N=18: first UNSAT K=0, first SAT K=9; TIMEOUT at K=[2, 3, 4, 5, 6, 7, 8, 10, 11, 13, 14, 16, 18, 21]
- N=19: first UNSAT K=0, first SAT K=2; TIMEOUT at K=[1, 6]
- N=21: first UNSAT K=—, first SAT K=0; TIMEOUT at K=[2, 3, 4]
- N=23: first UNSAT K=—, first SAT K=0; TIMEOUT at K=[2, 3, 4, 5]
...
Genuine N=18 models (`s SATISFIABLE`) on record: K=9, 12, 15, 17, 19, 20, 22, 23, 24, 25, 26
...
K=2, 3, 4, 5, 6, 7, 8, 10, 11, 13, 14, 16, 18, 21 TIMEOUT; K=9, 12, 15, 17, 19, 20, 22, 23, 24, 25, 26 SAT.
...
Disk: 464 GB of 3.7 TB used on `/`; `day_work` 51 GB.
