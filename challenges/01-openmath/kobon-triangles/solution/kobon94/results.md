...
- N=18: first UNSAT K=0, first SAT K=9; TIMEOUT at K=[2, 3, 4, 5, 6, 7, 8, 10, 11, 13, 14, 16, 18, 21, 27, 29, 30, 32, 33]
...
- N=25: first UNSAT K=—, first SAT K=—; TIMEOUT at K=[0, 1, 2, 3, 4]
...
A second, independent attack on the decisive band is live: `day_deep.py` (launched
12:34, 6 h cap = 21600 s per seed) runs **17 kissat seeds** over N=18 K=5,6,7,8
(8 seeds on K=6 — the decisive row — plus 3 each on K=5, K=7, K=8), logs in
`deep_work/deep-18-<K>-<seed>.log`, driver log `deep_run.log`. No seed has returned a
verdict yet; a `s SATISFIABLE` from any K=6 seed would be the discovery case.
...
K=2, 3, 4, 5, 6, 7, 8, 10, 11, 13, 14, 16, 18, 21, 27, 29, 30, 32, 33 TIMEOUT; K=9, 12, 15, 17, 19, 20, 22, 23, 24, 25, 26, 28, 31 SAT.
