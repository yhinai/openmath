...
- N=18: first UNSAT K=0, first SAT K=9; TIMEOUT at K=[2, 3, 4, 5, 6, 7, 8, 10, 11, 13, 14, 16, 18, 21, 27, 29, 30, 32, 33, 34]
...
- N=25: first UNSAT K=—, first SAT K=—; TIMEOUT at K=[0, 1, 2, 3, 4, 5]
...
`deep_results.txt`. The first portfolio (launched 12:34, 6 h cap = 21600 s per seed) was
**killed by a host reboot at ~14:40** with no verdict; the portfolio was relaunched at
14:44 on the restarted host (`deep_results.txt` was still empty, so nothing was lost and
no seed is skipped). A `s SATISFIABLE` from any K=6 seed would be the discovery case.

Genuine N=18 models (`s SATISFIABLE`) on record: K=9, 12, 15, 17, 19, 20, 22, 23, 24, 25, 26, 28, 31, 35, 36
...
K=2, 3, 4, 5, 6, 7, 8, 10, 11, 13, 14, 16, 18, 21, 27, 29, 30, 32, 33, 34 TIMEOUT; K=9, 12, 15, 17, 19, 20, 22, 23, 24, 25, 26, 28, 31, 35, 36 SAT.
...
Disk: 465 GB of 3.7 TB used on `/`; `day_work` 51 GB, `deep_work` 60 MB.
